...
values ('Armando José Santana', 12345678900, 'armandojsantana@outlook.com', 'm', '21/02/1961')
       , ('Shela Carvalho Leal', 45678909823, 'scarvalho@ig.com.br', 'f', '13/09/1978'  )
...
insert into tbProduto (descriçãoProduto, valorProduto, quantidadeProduto, codFabricante, codFornecedor)

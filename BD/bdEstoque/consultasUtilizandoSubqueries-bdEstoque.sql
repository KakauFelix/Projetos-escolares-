...
--1. Criar uma consulta que retorne o código do produto, o nome do produto e o nome do fabricante somente daqueles 
--produtos que custam igual ao valor mais alto;
SELECT codProduto AS'Código do Produto', descricaoProduto AS'Nome do Produto', nomeFabricante AS'Nome do Fabricante' FROM tbProduto
...
--acima do valor médio dos produtos em estoque
